...
export default Vue.extend({
  ...
  methods: {
    async getAllUsers() {
      try {
        let response = await this.$axios.get('/api/auth/users')
    ...
    async setAdmin(user: User) {
      try {
        await this.$axios.post(`/api/auth/users/${user.uuid}/admin`)
    ...
    async resetHwid(user: User) {
      try {
        await this.$axios.post(`/api/auth/users/${user.uuid}/hwid`)
    ...
    async setAccess(user: User) {
      try {
        await this.$axios.post(`/api/auth/users/${user.uuid}/access`)
