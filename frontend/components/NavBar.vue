    ...
    <div class="flex items-center justify-between">
      ...
      <div class="hidden md:block">
        <ul class="flex space-x-6 text-sm ">
          ...
          <li v-if="$auth.loggedIn && $auth.user.admin" class="hover:border-bluh border-accent border-b-2">
          ...
          <li v-else>
            <a class="cta bg-bluh hover:bg-bluh-600 px-3 py-2 rounded text-white font-semibold" @click="$auth.logout()">Logout</a>
          </li>
        </ul>
      </div>
